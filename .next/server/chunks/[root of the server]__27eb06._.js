...
async function GET() {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(); // Connect to the database
        const teachers = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Users$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
            role: "Professeur"
        }) // Find users with the "Professeur" role
        .sort({
            lastName: 1
        }); // Sort by lastName in ascending order
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(teachers); // Return the results as JSON
    } catch (error) {
        console.log(error);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__27eb06._.js.map