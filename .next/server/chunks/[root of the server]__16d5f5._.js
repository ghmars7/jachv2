...
"[project]/models/Users.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
UserSchema.pre("save", async function(next) {
    ...
    this.password = await __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$bcrypt$2c$__cjs$29$__.hash(this.password, 10);
    next();
});
// Méthode d'instance pour comparer les mots de passe
UserSchema.methods.comparePassword = async function(candidatePassword) {
    return __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$bcrypt$2c$__cjs$29$__.compare(candidatePassword, this.password);
};
// Création et exportation du modèle User
const UserModel = __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].models.UserUser || __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].model("User", UserSchema);
const __TURBOPACK__default__export__ = UserModel;
}}),
"[project]/models/Classes.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/app/api/students/import/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Student$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/models/Student.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__ = __turbopack_import__("[externals]/ [external] (mongoose, cjs)");
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Users$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/models/Users.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Classes$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/models/Classes.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_import__("[project]/lib/db.ts [app-route] (ecmascript) <locals>");
;
;
;
...
async function POSTCLASSES() {
    try {
        ...
        // Fetch all students
        const students = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Student$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find();
        ...
        // Fetch all teachers
        const teachers = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Users$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
            role: "Professeur"
        });
        ...
        const classes = Object.keys(groupedClasses).map((className)=>{
            ...
            return {
                ...
                students: groupedClasses[className].students.map((s)=>({
                        id: s.id,
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Classes$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].insertMany(classes);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function POST(request) {
    try {
        ...
        if (!Array.isArray(students)) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]("Invalid data format", {
                status: 400
            });
        }
        const preparedStudents = students.map((student)=>({
                id: new __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["Types"].ObjectId().toString(),
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__16d5f5._.js.map