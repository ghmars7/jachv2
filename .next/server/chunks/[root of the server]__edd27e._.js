...
"[project]/utils/PasswordGenerator.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$PasswordGenerator$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/utils/PasswordGenerator.ts [app-route] (ecmascript)");
;
;
;
...
UserSchema.pre("save", async function(next) {
    ...
    this.password = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$PasswordGenerator$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["passwordGenerator"])();
    next();
});
...
async function POST(request) {
    try {
        ...
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["UserModel"].findOne({
            email
        });
        if (!user) {
        ...
        // Générer le token
        const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateToken"])(user);
        console.log('deed');
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            token,
            user: {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__edd27e._.js.map