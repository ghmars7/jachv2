...
async function GET() {
    try {
        ...
        const students = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Student$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({}).sort({
            lastName: 1
        });
...
async function POST(request) {
    try {
        ...
        const student = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Student$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create(data);
        const updatedClass = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Classe$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOneAndUpdate({
            level: student.class
        }, {
            $push: {
                students: {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__4de6bf._.js.map