...
async function GET() {
    try {
        ...
        const classes = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Classes$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({}) // Find Students with the "Professeur" role
        .sort({
            level: 1
        }); // Sort by lastName in ascending order
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(classes); // Return the results as JSON
    } catch (error) {
        console.log(error);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__961abe._.js.map