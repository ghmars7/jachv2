(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_3966ea._.js", {
...
const EditUserPage = ()=>{
    ...
    const { id } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"])(); // Get user ID from route params
    // Fetch user data
    ...
    const handleSubmit = async (event)=>{
        ...
        try {
            ...
            const updatedFormData = formData.role === "Admin" ? {
                ...formData,
                class: ""
            } : formData;
...
_s(EditUserPage, "lZzHkPgHTx15BLDUgmY+9bjdSqQ=", false, function() {
    return [
...
var _c;
__turbopack_refresh__.register(_c, "EditUserPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/app/dashboard/users/[id]/edit/page.tsx [app-rsc] (ecmascript, Next.js server component, client modules)": ((__turbopack_context__) => {
...
//# sourceMappingURL=_3966ea._.js.map